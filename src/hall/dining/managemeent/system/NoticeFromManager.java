 ...
 * @author sami
 */
public class NoticeFromManager extends javax.swing.JFrame {
     ...
     */ 
    public NoticeFromManager() {
        initComponents();
        //btnPost.setEnabled(false);
        showNotice();
    }

    public NoticeFromManager(String email) {
        initComponents();
        userEmail = email;
        //btnPost.setEnabled(false);
        showNotice();
    ...
    public void showNotice()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                dateTimeLabel.setText(managerNotice.getDate());
                txtNotice.setText(managerNotice.getNotice()); 
            }
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sidebarIcon/icons8-noticeboard-50.png"))); // NOI18N
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 0, -1, -1));
    ...
    private void btnPostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPostActionPerformed
        ...
        managerNotice.setDate(currentDateTime);
        managerNotice.setNotice(txtNotice.getText());

        //ManagerNoticeDao.saveNotice(managerNotice);
        ManagerNoticeDao.updateNotice(managerNotice.getDate(), managerNotice.getNotice());

        //clear();
        setVisible(false);
        new NoticeFromManager(userEmail).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoticeFromManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NoticeFromManager().setVisible(true);
            }
        });
    }
